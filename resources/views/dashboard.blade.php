...
<div class="row">
  <!-- panel -->
  <div class="col-md-2 col-xs-12 col-half-offset">
    <!-- small box -->
  ...
  <div class="col-md-2 col-xs-12 col-half-offset">
   ...
   <div class="col-md-2 col-xs-12 col-half-offset">
    ...
    <div class="small-box bg-user">
      <div class="inner">
        <h3> {{ number_format(\App\Models\Component::count()) }}</h3>
      ...
      @can('index', \App\Models\User::class)
        <a href="{{ route('components.index') }}" class="small-box-footer">{{ trans('general.moreinfo') }} <i class="fa fa-arrow-circle-right"></i></a>
      @endcan
    </div>
  </div><!-- ./col -->
</div>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            @can('create', \App\Models\Consumable::class)
                                <a class="btn bg-user" style="width: 100%" href="{{ route('users.create') }}">New People</a>
                            @endcan
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table
                            ...
                            <thead>
                            <tr>
                                <th class="col-sm-2" data-field="name" data-formatter="categoriesLinkFormatter">{{ trans('general.categories') }}</th>
                                <th class="col-sm-2" data-field="assets_count">{{ trans('general.counts') }}</th>
                            </tr>
                            </thead>
                        </table>
                    </div> <!-- /.col -->
...
<!-- <div class="box box-default" style="min-height: 400px;"> -->
          <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('general.asset_models') }}</h3>
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                    </button>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table
                            ...
                            <thead>
                            <tr>
                                <th class="col-sm-2" data-field="name" data-formatter="modelsLinkFormatter">{{ trans('general.assets') }}</th>
                                <th class="col-sm-2" data-field="assets_count">{{ trans('general.counts') }}</th>
                            </tr>
                            </thead>
                        </table>
                    ...
                    <div class="col-md-12 text-center" style="padding-top: 10px;">
                        <a href="{{ route('models.index') }}" class="btn btn-primary btn-sm" style="width: 100%">View All</a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table
                            ...
                            <thead>
                            <tr>
                                <th class="col-sm-2" data-field="name" data-formatter="locationsLinkFormatter">{{ trans('general.locations') }}</th>
                                <th class="col-sm-2" data-field="assets_count">{{ trans('general.counts') }}</th>
                            </tr>
                            </thead>
                        </table>
                    ...
                    <div class="col-md-12 text-center" style="padding-top: 10px;">
                        <a href="{{ route('locations.index') }}" class="btn btn-primary btn-sm" style="width: 100%">View All</a>
                    </div>
                </div>
