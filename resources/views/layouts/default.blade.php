...
<html>
  ...
  <body class="sidebar-mini skin-blue {{ (session('menu_state')!='open') ? 'sidebar-mini sidebar-collapse' : ''  }}">
    <div class="wrapper">
                 ...
                 @if ($snipeSettings->brand == '3')
                  ...
                  @else
                      <a class="logo no-hover" href="{{ url('/') }}">
                         <img class="navbar-brand-img" src="{{ url('/') }}/uploads/bct_logo.jpg"> {{ $snipeSettings->site_name }}
                      </a>
                  @endif
              </li>
            </ul>
      ...
      <div class="pull-right hidden-xs">Let's stay connected  

      <a href="http://www.facebook.com/pages/Bahwan-CyberTek/189517081065309" target="_blank" border="0" alt="Facebook" class="btn btn-social-icon btn-facebook">
      <i class="fa fa-facebook"></i></a>    
      <a href="http://www.youtube.com/channel/UCcPQvCi0CWjVMMdJu-0G2-g" target="_blank" border="0" alt="Youtube" class="btn btn-social-icon btn-dropbox"><i class="fa fa-youtube"></i></a>
      <a href="http://www.linkedin.com/company/206605?trk=tyah" target="_blank" border="0" alt="Linked In" class="btn btn-social-icon btn-linkedin"><i class="fa fa-linkedin"></i></a>
      <a href="http://www.twitter.com/BCTglobal" target="_blank" border="0" alt="Twitter" class="btn btn-social-icon btn-twitter"><i class="fa fa-twitter"></i></a>
     
    </div>

        <a target="_blank" href="http://www.bahwancybertek.com/" rel="noopener">© 2017 </a> Bahwan CyberTek <i class="fa fa-heart" style="color: #a94442; font-size: 10px"></i> <!-- by <a href="https://twitter.com/snipeyhead" rel="noopener">@snipeyhead</a> under the <a href="https://www.gnu.org/licenses/agpl-3.0.en.html" rel="noopener">AGPL3 license</a>. -->
      </footer>
